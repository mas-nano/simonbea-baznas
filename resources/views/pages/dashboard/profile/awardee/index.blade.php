                    ...
                    <div class="col-12 col-md-7 col-lg-7">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Status</label>
                                    <p>{{ $awardee->awardee == null ? 'Belum diisi' : ucfirst($awardee->awardee->status) }}
                                    </p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>{{ $awardee->awardee == null ? 'Menunggu Operator' : ($awardee->awardee->operator == null ? 'Menunggu Operator' : $awardee->awardee->operator->name) }}
                                    </p>
                                </div>
                            </div>
